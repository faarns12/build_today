...
export default function Navbar() {
  ...
  return (
    <div className="w-full flex justify-center">
      ...
      <nav
  className={`w-11/12 sm:w-10/12 lg:w-9/12 h-14 shadow-md z-40 md:bg-white md:backdrop-blur-md md:border fixed md:border-white/30 rounded-[17px] px-3 sm:px-2 flex items-center justify-between transition-transform duration-500 ease-in-out ${
